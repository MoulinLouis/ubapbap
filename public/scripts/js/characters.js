...
switch(currentCharName) {
    ...
    case "froggy":
        currentChar = {
            ...
            stats_duo_1: {
                nb_games: 6525,
                kill_per_game: Math.round((6525 / 7423) * 100) / 100,
                assist_per_game: Math.round((6525 / 7274) * 100) / 100,
                death_per_game: Math.round((6525 / 4629) * 100) / 100,
                pickrate: Math.round((0.1642 * 100) * 100) / 100,
                win: 639,
                winrate: Math.round((639 / 6525) * 100),
                avg_dmg: Math.round(11080.70406 * 100) / 100,
            },
            stats_trio_2: {
                nb_games: 4832,
                kill_per_game: Math.round((4832 / 5497) * 100) / 100,
    ...
    case "kiddo":
        currentChar = {
            ...
            stats_duo_1: {
                nb_games: 3204,
                kill_per_game: Math.round((3204 / 3676) * 100) / 100,
                assist_per_game: Math.round((3204 / 3519) * 100) / 100,
                death_per_game: Math.round((3204 / 2713) * 100) / 100,
                pickrate: Math.round((0.8062 * 100) * 100) / 100,
                win: 341,
                winrate: Math.round((341 / 3204) * 100),
                avg_dmg: Math.round(12526.27559 * 100) / 100,
            },
            stats_trio_2: {
                nb_games: 4832,
                kill_per_game: Math.round((4832 / 5497) * 100) / 100,
    ...
    case "sashimi":
        currentChar = {
            ...
            stats_duo_1: {
                nb_games: 2989,
                kill_per_game: Math.round((2989 / 2326) * 100) / 100,
                assist_per_game: Math.round((2989 / 3252) * 100) / 100,
                death_per_game: Math.round((2989 / 2340) * 100) / 100,
                pickrate: Math.round((0.07521 * 100) * 100) / 100,
                win: 234,
                winrate: Math.round((234 / 2989) * 100),
                avg_dmg: Math.round(10009.47239 * 100) / 100,
            },
            stats_trio_2: {
                nb_games: 4832,
                kill_per_game: Math.round((4832 / 5497) * 100) / 100,
    ...
    case "skinny":
        currentChar = {
            ...
            stats_duo_1: {
                nb_games: 7727,
                kill_per_game: Math.round((7727 / 8246) * 100) / 100,
                assist_per_game: Math.round((7727 / 8679) * 100) / 100,
                death_per_game: Math.round((7727 / 5241) * 100) / 100,
                pickrate: Math.round((0.1944 * 100) * 100) / 100,
                win: 687,
                winrate: Math.round((687 / 7727) * 100),
                avg_dmg: Math.round(10718.04568 * 100) / 100,
            },
            stats_trio_2: {
                nb_games: 4832,
                kill_per_game: Math.round((4832 / 5497) * 100) / 100,
